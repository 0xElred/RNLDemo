...
const UploadInput: FC<UploadInputProps> = ({label, name, value, onChange, onRemoveExistingImageUrl, existingImageUrl, errors}) => {const [preview, setPreview] = useState<string | null>(null)
