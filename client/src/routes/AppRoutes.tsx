  ...
  return (
    <>
      ...
      <div className="mb-4">
        ...
        <p className="font-medium">First Name: {firstName}
      ...
      <div className="mb-4">
        ...
        <p className="font-medium">Last Name: {lastName}
      ...
      <div className="mb-4">
        ...
        <p className="font-medium">Birth Date: {birthDate}
      ...
      <div className="mb-4">
        ...
        <p className="font-medium">Password: {password}

        </p>
      </div>
      <div className="mb-4">
        <FloatingLabelSelect label="Gender" name="gender" value={gender} onChange={(e) => setGender(e.target.value)}>
          {genders.map((gender, index) => (<option value={gender.value} key={index}> {gender.text}
      ...
      <div className="overflow-hidden rounded-lg border border-gray-200 bg-white">
        <div className="nax-w-full max-h-[calc(100vh)] overflow-x-auto">
          <Table>
            <TableHeader className="border-b-2 border-gray-100 bg-blue-600 text-white sticky-top-0 z-30 text-xs">
              <TableRow>
